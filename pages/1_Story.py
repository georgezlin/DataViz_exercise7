...
st.header("5) Weather type distribution by month")
st.write("Finally, we want to break down what kind of weather each month brings to reveal the distrubtion of sun, rain, drizzle, fog, and snow.")
st.altair_chart(chart_weather_distribution(df), use_container_width=True)
st.caption("Takeaway: Summer months are dominated by sunny days, while winter months have a much larger share of fog and rain. Snow is more rare and confined to the colder months.")
