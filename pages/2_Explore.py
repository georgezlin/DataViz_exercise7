...
from charts.charts import chart_dashboard, chart_temp_range_interactive
...
st.altair_chart(chart_temp_range_interactive(df), use_container_width=True)

st.markdown("**Guided prompts:**")
st.write("- Click a weather type in the legend—what is the min–max relationship?")
st.write("- Compare sun and rain—which has a wider temperature range?")
st.write("- Identify outliers—what weather types produce the largest daily swings?")
